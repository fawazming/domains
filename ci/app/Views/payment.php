            ...
            <div class="container ">
                <div class="row justify-content-center align-items-center">
                    <div class="section-title text-center mb-5">
                        <h4 class="title text-dark title-dark mb-3">Payment</h4>
                        <p class="subtitle">Choose a Payment Method</p>
                    </div>
                    <div class="col-lg-5 mr-lg-1 col-md-6 col-12 mb-3">
                        <a href="#" class="text-dark h6 me-3 login" data-bs-toggle="modal" data-bs-target="#Register">
                        <div class="card services serv-primary rounded p-4 bg-light position-relative overflow-hidden border-0 text-dark">
                            <div class="card-body p-0 content d-flex justify-content-between align-items-center">
                                <div>
                                   <h5 class="">Flutterwave</h5>
                                    <p class="para text-muted mb-0">1.4% extra charges - VAT</p> 
                                </div>
                                <p class="lead">₦1999/yr</p>
                    ...
                    <div class="col-lg-5 mr-lg-1 col-md-6 col-12 mb-3">
                        ...
                        <div class="card services serv-primary rounded p-4 bg-light position-relative overflow-hidden border-0 text-dark">
                            <div class="card-body p-0 content d-flex justify-content-between align-items-center">
                                <div>
                                   <h5 class="">Paystack</h5>
                                    <p class="para text-muted mb-0">1.5% extra charges - VAT</p> 
                                </div>
                                <p class="lead">₦1999/yr</p>
                    ...
                    <div class="col-lg-5 mr-lg-1 col-md-6 col-12 mb-3">
                        ...
                        <div class="card services serv-primary rounded p-4 bg-light position-relative overflow-hidden border-0 text-dark">
                            <div class="card-body p-0 content d-flex justify-content-between align-items-center">
                                <div>
                                   <h5 class="">Payflow</h5>
                                    <p class="para text-muted mb-0">0.2% extra charges - VAT</p> 
                                </div>
                                <p class="lead">₦1999/yr</p>
